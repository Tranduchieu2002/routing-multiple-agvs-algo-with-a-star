    ...
    def __init__(
        ...
        if bold:
            font = pygame.font.Font(
                "fonts/BeVietnamPro-Medium.ttf", font_size)
        else:
            font = pygame.font.Font(
                "fonts/BeVietnamPro-Medium.ttf", font_size)

        self.text_surf = font.render(str(text), True, foreground_color)
...
class Frame:
    ...
    def mount(self, widget, x, y):
        widget.rect.x = self.rect.x + x
        widget.rect.y = self.rect.y + y
    ...
    def draw(self):
        ...
        for child in self.children:
            if hasattr(child, 'set_surface'):  # Check if the child has a set_surface method
                child.set_surface(self.surface)  # Set the surface for the child widget
            child.draw()
